package com.goshare.render
{
	...
	public class ItemRenderForSelectList extends DefaultItemRenderer
	{
		public function ItemRenderForSelectList()
		{
			super();
			mouseChildren = true;
		}
		...
		override protected function drawSkin():void
		{
			...
			icon.source = selected?"assets/personalCenter/"+data["fileType"]+"_selected.png":"assets/personalCenter/"+data["fileType"]+"_unSelected.png"
		}
	}
}