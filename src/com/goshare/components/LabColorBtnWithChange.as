package com.goshare.components
{
	 ...
	 * @author Coco
	 */	
	public class LabColorBtnWithChange extends UIComponent 
	{
		
		public function LabColorBtnWithChange() 
		{
			super();
		...
		public var statusLock : Boolean = false;
		public var WhichStatus : Boolean = false;
		...
		override protected function drawSkin():void
		{
			...
			if(!statusLock)
			{
				labelDisplay.color = mouseDownFlag?0xffffff:0x5c9dfd;
				
				// draw bg skin
				graphics.clear();
				graphics.lineStyle(1, 0x5c9dfd);
				graphics.beginFill(mouseDownFlag?0x5c9dfd:0xffffff);
				graphics.drawRoundRect(0, 0, width, height,radius,radius);
				graphics.endFill();
			}
			else
			{
				labelDisplay.color = WhichStatus?0xffffff:0x5c9dfd;
				
				// draw bg skin
				graphics.clear();
				graphics.lineStyle(1, 0x5c9dfd);
				graphics.beginFill(WhichStatus?0x5c9dfd:0xffffff);
				graphics.drawRoundRect(0, 0, width, height,radius,radius);
